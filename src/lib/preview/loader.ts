...
// Loads all pages for an order and resolves illustration signed URLs.
// Uses the real schema: pages are stored one row per page per order,
// always queried by order_id. No story_drafts or story_draft_id.
